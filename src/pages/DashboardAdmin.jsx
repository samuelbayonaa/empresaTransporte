      ...
      <nav className="bg-blue-600 shadow-lg">
        <div className="container flex items-center justify-between px-6 py-3 mx-auto">
          ...
          <div className="space-x-4">
            <Link to="/dashboard-admin" className="text-white transition duration-300 hover:text-blue-200">Inicio</Link>
          </div>
        </div>
      </nav>
          ...
          {filtrarCamiones.map(camion => (
            <div key={camion.id} className="overflow-hidden transition duration-300 bg-white rounded-lg shadow-md hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <Link to={`/detallescamion/${camion.id}`} className="inline-block px-4 py-2 mt-4 text-white transition duration-300 bg-blue-600 rounded hover:bg-blue-700">
                  Ver detalles
                </Link>
              </div>
            </div>
